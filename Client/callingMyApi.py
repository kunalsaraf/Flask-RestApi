...
localhost_url = 'http://127.0.0.1:5000/third'
server_url = 'http://sipher.codes/third'
...
print("Making Post Requests to Server")
response_sent_by_server = requests.post(server_url, json = my_json_data)
print(response_sent_by_server)
